...
public class ClientThread implements Runnable {
    ...
    private void handleReceiveInviteResponse(Response response) {
        client.setBusy(true);
        Invite receivedInvite = (Invite) response.getValue();
        String opponentName = receivedInvite.getOpponentName();
        int size = receivedInvite.getSize();
        client.setOpponentName(opponentName);
        client.setSize(size);
